...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "app_uaa@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "app_uaa API";

        private String description = "app_uaa API documentation";
